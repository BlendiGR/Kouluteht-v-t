...
const luoKortit = () => {
    picArray.forEach((kuva) => {
        ...
        kuvaElementti.src = kuva.image.medium;
        kuvaElementti.alt = kuva.title;

        const kuvateksti = document.createElement("figcaption");
        kuvateksti.textContent = kuva.caption;

        const figure = document.createElement("figure");
        figure.appendChild(kuvaElementti);
        ...
        artikkeli.addEventListener("click", () => {
            const modaali = document.querySelector("dialog");
            const modaaliKuva = modaali.querySelector("img");
            modaaliKuva.src = kuva.image.large;
            modaaliKuva.alt = kuva.title;
            modaali.showModal();
        });

        document.querySelector("#pictures").appendChild(artikkeli);
    });
};
